...
function rHist(){
  ...
  for(var i=0;i<page.length;i++){
    ...
    rows+='<tr><td>'+fmt(v.fecha)+(v.hora?' <span class="tm2">'+v.hora+'</span>':'')+'</td>'+
      ...
      '<td>'+(v.producto||'---')+(v.es_regalo?' <span class="b b-visita" title="Unidades de regalo, sin costo"><svg class="ic" aria-hidden="true" focusable="false" viewBox="0 0 24 24" style="width:11px;height:11px;vertical-align:-1px;"><use href="#i-regalo"/></svg> Regalo</span>':'')+'</td>'+
      '<td>'+(v.cantidad||0)+'</td>'+
