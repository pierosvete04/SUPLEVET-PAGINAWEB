...
const HERO_BANNER_FALLBACK = "/images/hero/banner-nuevas-presentaciones.png";
...
export function Hero({ bannerDesktop, bannerMobile }: HeroProps) {
  const desktopSrc = bannerDesktop || HERO_BANNER_FALLBACK;
  const mobileSrc = bannerMobile || HERO_BANNER_FALLBACK;
